...
~~~
Please fillup the [Dataset Agreement Form](https://github.com/Debojyoti7/Solar_Energy_Prediction_SRRA/blob/main/assets/Dataset_Agreement_Form.pdf) and mail to hbarua@acm.org to get access.
~~~
